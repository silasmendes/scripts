-- Script shared with me by my colleague Thomas Bragaloni.
-- ======================================================================================
-- Create SQL Login template for Azure SQL Data Warehouse Database
-- ======================================================================================
...
CREATE USER mendes FOR LOGIN mendes;
GO
...
EXEC sp_addrolemember 'db_owner', 'mendes';
GO
EXEC sp_addrolemember 'xlargerc', 'mendes';
GO


--- 25 minutes to execute in a DWU 100.
--- 13 minutos on the DW400
--- 6 minutos on the DW500c / staticrc60
/*************************************************************************************************
...
-- INSERT INTO CCI_FactSales_Non_Skewed
-- SELECT id+50000000, idSeller,	idProduct,	idTerritory,	Qty+10,	Amount FROM CCI_FactSales_WritesImpact



--CREATE VIEW vw_CCI_FactSales_Skewed
--AS
--SELECT id+50000000 AS ID,	idSeller,	idProduct,	idTerritory,	Qty+10  AS QTD,	Amount+10 AS AMT FROM CCI_FactSales_Skewed
--UNION
--SELECT id+90000000 AS ID,	idSeller,	idProduct,	idTerritory,	Qty+10 AS QTD,	Amount+10 AS AMT FROM CCI_FactSales_Skewed
--GO

--INSERT INTO CCI_FactSales_Skewed
--SELECT * FROM vw_CCI_FactSales_Skewed
